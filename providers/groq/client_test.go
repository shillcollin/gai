...
func TestGenerateText(t *testing.T) {
	...
	if captured["model"].(string) != "llama3-8b-8192" {
		t.Fatalf("model not set in request")
	}
}

func TestStreamText(t *testing.T) {
	events := "data: {\"id\":\"chatcmpl\",\"model\":\"llama3-8b-8192\",\"choices\":[{\"delta\":{\"content\":[{\"type\":\"text\",\"text\":\"Hel\"}]}}]}\n\n" +
		"data: {\"id\":\"chatcmpl\",\"model\":\"llama3-8b-8192\",\"choices\":[{\"delta\":{\"content\":[{\"type\":\"text\",\"text\":\"lo\"}]},\"finish_reason\":\"stop\"}],\"usage\":{\"prompt_tokens\":12,\"completion_tokens\":3,\"total_tokens\":15}}\n\n" +
		"data: [DONE]\n\n"
...
func TestBuildChatPayloadMultimodal(t *testing.T) {
	client := New(WithModel("llama3-8b-8192"))
