...
func TestAudio_Transcribe_Basic(t *testing.T) {
	...
	transcript, err := testClient.Audio.Transcribe(ctx, &vango.TranscribeRequest{
		Audio:    audioData,
		Model:    "ink-whisper",
		Language: "en",
	})
...
func TestAudio_Synthesize_Basic(t *testing.T) {
	...
	result, err := testClient.Audio.Synthesize(ctx, &vango.SynthesizeRequest{
...
func TestAudio_Synthesize_WithSpeed(t *testing.T) {
	...
	normalResult, err := testClient.Audio.Synthesize(ctx, &vango.SynthesizeRequest{
		Text:   text,
	...
	fastResult, err := testClient.Audio.Synthesize(ctx, &vango.SynthesizeRequest{
		Text:   text,
		Voice:  "a0e99841-438c-4a64-b679-ae501e7d6091",
		Speed:  1.5,
		Format: "wav",
...
func TestAudio_StreamSynthesize_Basic(t *testing.T) {
	...
	stream, err := testClient.Audio.StreamSynthesize(ctx, &vango.SynthesizeRequest{
		Text:   "Hello world.",
		Voice:  "a0e99841-438c-4a64-b679-ae501e7d6091",
		Format: "pcm",
	})
